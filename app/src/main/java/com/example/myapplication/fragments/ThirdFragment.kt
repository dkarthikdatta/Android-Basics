...
class ThirdFragment: Fragment() {
    ...
    companion object {
        public fun newInstance(someInputString: String?, someInputInt: Int?): ThirdFragment{
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_third, container, false) // always false for fragments
    }
